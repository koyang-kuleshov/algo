...
cProfile.run('get_str1("1234567812345678")')
         # 97 function calls (82 primitive calls) in 0.000 seconds

   # Ordered by: standard name

   # ncalls  tottime  percall  cumtime  percall filename:lineno(function)
        # 1    0.000    0.000    0.000    0.000 <string>:1(<module>)
     # 16/1    0.000    0.000    0.000    0.000 lesson_4.1.py:10(get_str1)
        # 1    0.000    0.000    0.000    0.000 {built-in method builtins.exec}
       # 78    0.000    0.000    0.000    0.000 {built-in method builtins.len}
...
cProfile.run('get_str2(1234567812345678)')
...
#    ncalls  tottime  percall  cumtime  percall filename:lineno(function)
#         1    0.000    0.000    0.000    0.000 <string>:1(<module>)
#         1    0.000    0.000    0.000    0.000 lesson_4.1.py:31(get_str2)
#         1    0.000    0.000    0.000    0.000 {built-in method builtins.exec}
#         1    0.000    0.000    0.000    0.000 {method 'disable' of '_lsprof.Profiler' objects}
